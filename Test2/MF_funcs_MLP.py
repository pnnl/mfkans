...
class MF_KAN:
    ...
    def simple_out_fn(self, xHF, params):
        ...
        preds_HF = vmap(self.op_net, (None, 0))(params, xHF.reshape(-1, 1, 1))
    ...
    def both_out(self, xHF, params):
        ...
        preds_nonlin, preds_lin, preds_LF_on_HF = vmap(self.op_both, (None, 0))(params, xHF.reshape(-1, 1, 1))
        return preds_nonlin, preds_lin, alpha, preds_LF_on_HF




    def simple_loss_fn(self, params, xHF, yHF):
        predsHF = self.op_net(params, xHF)
    
        params_nl, params_l, alpha = params

        loss_pred = (jnp.mean((predsHF.flatten()-yHF.flatten())**2)) + .01*alpha[0]**4
        return loss_pred
    ...
    def train(self, num_epochs, t_data, s_data):
        ...
        for epoch in pbar:
            ...
            if epoch % 100 == 0:
                ...
                loss = self.simple_loss_fn(params, t_data, s_data)
                params_nl, params_l, alpha = params
