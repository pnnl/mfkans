...
class MF_KAN:
    def __init__(self, layer_dims_nl, layer_dims_l, SF_model, SF_variables, boundaries, scales, 
        ...
        self.modelHF_nl = KAN(layer_dims=layer_dims_nl, k=2, const_spl=1.0, const_res=False, add_bias=True, grid_e=1.0, j='0')
    ...
    def simple_out_fn(self, xHF, varis):
        ...
        preds_HF, _, _ = vmap(self.op_net, (None, 0, None))(params, xHF.reshape(-1, 1, 1), states)
    ...
    def simple_loss_fn(self, params, xHF, yHF, state):
        ...
        loss_pred = (jnp.mean((predsHF.flatten()-yHF.flatten())**2)) + 100*alpha[0]**2\
    ...
    def train(self, num_epochs, t_data, s_data):
        ...
        for epoch in pbar:
            ...
            if epoch in self.grid_upds.keys():
                ...
                t = jnp.linspace(0, 1, 10).reshape(-1, 1)
                preds_LF_on_HF = self.modelLF.simple_out_fn(t, self.SF_variables)

                invals = jnp.hstack([t, preds_LF_on_HF])
