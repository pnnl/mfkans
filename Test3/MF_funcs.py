...
class MF_KAN:
    ...
    def train(self, num_epochs, t_data, t_grid, s_data):
        ...
        for epoch in pbar:
            ...
            if epoch in self.grid_upds.keys():
                ...
                preds_LF_on_HF = self.modelLF.simple_out_fn(t_grid, self.SF_variables)

                invals = jnp.hstack([t_grid, preds_LF_on_HF])
            ...
            if epoch % 100 == 0:
                ...
                pbar.set_postfix({'Loss': "{0:.8f}".format(loss),'Test HF': "{0:.8f}".format(loss_HF),
